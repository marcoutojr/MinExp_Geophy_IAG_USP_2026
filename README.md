# Mineral Exploration Geophysics - IAG-USP Summer School 2026

Repository to organize the coding material for the course Mineral Exploration Geophysics IAG Summer School 2026

## Material used in this reposity

 - The oepn-source material used for the Century deposit example comes from the [Transform 2020 tutorial][https://github.com/simpeg/transform-2020-simpeg/tree/main]. Only an update to export the inversion results to the [Mira Geoscience Analyst was made][].
